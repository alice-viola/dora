...
module.exports.formatWorkload = (body) => {
	try {
		...
		// Set configs		
		if (body.spec.config !== undefined && body.spec.config.cmd !== undefined && typeof body.spec.config.cmd == 'string') {
			workload.createOptions.Cmd = body.spec.config.cmd.split(/\s+/)
		} else if (body.spec.config !== undefined && body.spec.config.cmd !== undefined && (typeof body.spec.config.cmd == 'array' || typeof body.spec.config.cmd == 'object')) {
			workload.createOptions.Cmd = body.spec.config.cmd
		}
