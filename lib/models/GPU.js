...
module.exports = class GPU extends R.Resource {
  ...
  setAssigned () {
    this._p.assigned = true
  }

  unsetAssigned () {
    this._p.assigned = false
  }
  ...
  _formatRes (res) {
      ...
      result.sort((a, b) => {return (a.product_name > b.product_name) ? 1 : ((b.product_name > a.product_name) ? -1 : 0) })
      return result
  }
  ...
  _formatOneRes (res) {
      ...
      return {
          ...
          status: (res.assigned !== undefined && res.assigned !== null) ? (res.assigned == false ? 'FREE' : 'BOOKED' ) : 'UNKNOWN' ,
