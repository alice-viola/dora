...
module.exports.setFsModule = (fsm) => {
	fs = fsm 
}
...
module.exports.profile.mkdirAppHome = (cfgFolder) => {
	try {
		return fs.mkdirSync(cfgFolder, { recursive: true })
...
module.exports.profile.using = () => {
	return self.profile.CFG.profile
}

module.exports.profile.getOne = (name) => {
	return self.profile.CFG.api[name]
}
