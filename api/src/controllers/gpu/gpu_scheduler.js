...
scheduler.addLine('fetchGpuDataFromDb', require('./gpu_fetch_db_pipeline'), [], {
	runEveryMs: 1000
})

scheduler.addLine('fetchGpuFromNodes', require('./gpu_fetch_nodes_pipeline'), [], {
	runEveryMs: 10000
})

scheduler.addLine('gpuAssignedToLaunch', require('./gpu_toassign_pipeline'), [], {
